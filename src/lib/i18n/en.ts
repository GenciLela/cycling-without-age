...
const en = {
  ...
  passenger: {
    ...
    home: {
      greeting: "Hello, {name}",
      greetingGuest: "The right to wind in your hair",
      book: "Book a ride",
      bookHint: "A volunteer pedals. You sit at the front.",
      bookAria: "Book a ride with {chapter}",
      profileAria: "Your profile",
      signIn: "Sign in",
      nextRide: "Your next ride",
      withChapter: "With {chapter}",
      noChapterYet:
        "You haven't picked a chapter yet. Choose one and the ride is two taps away.",
    ...
    book: {
      ...
      whoHint: "Pick the person who will sit at the front.",
      ...
      notePlaceholder:
        "A walking frame, a favourite route, a friend joining me…",
      submit: "Send my request",
      sending: "Sending…",
      sent: "Your request is with the chapter.",
      pending:
        "A volunteer will confirm the day and time with you. Nothing is fixed yet.",
      errors: {
        invalid: "Something in that request didn't come through. Try again.",
        noPassenger:
          "There's no rider on your account yet. Your chapter can add one.",
    ...
    rides: {
      ...
      empty: "No rides yet.",
      emptyBody:
        "When you ask for a ride it waits here until a volunteer confirms it.",
      book: "Book a ride",
      askedOn: "Asked on {date}",
      note: "Your note",
      cancel: "Cancel this ride",
      cancelTitle: "Cancel your ride on {date}?",
      cancelBody:
        "The chapter is told right away, and the trishaw goes back to someone else. You can always ask again.",
    ...
    messages: {
      ...
      emptyBody:
        "Soon your chapter can write to you here — a change of plan, a hello from your pilot. Until then they'll call or email.",
    },
    profile: {
      title: "Profile",
      rider: "Rider",
